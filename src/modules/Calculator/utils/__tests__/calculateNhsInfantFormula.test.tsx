...
describe("calculateNhsInfantFormula", () => {
  it("returns correct min/max for typical input (4kg, 30 days)", () => {
    ...
    expect(result).toEqual({ dailyVolumeMin: 600, dailyVolumeMax: 800 });
  });
